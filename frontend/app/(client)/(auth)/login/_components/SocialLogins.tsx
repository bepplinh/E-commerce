...
import { handleGoogleLogin } from "@/actions/auth/google-login";
...
function GoogleLoginButton() {
    ...
    return (
        <button
            onClick={() => googleLogin()}
            type="button"
            className="col-span-2 flex items-center justify-center gap-3 w-full py-3 px-4 border border-gray-300 rounded-lg hover:bg-gray-50 transition-colors duration-200"
        >
